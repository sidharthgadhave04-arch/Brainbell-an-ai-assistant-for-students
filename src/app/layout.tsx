...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body 
        className={`${inter.variable} ${lexend.variable} font-sans antialiased min-h-screen transition-theme bg--background`}
      >
        {/* Theme handling removed: app no longer toggles dark mode */}
        <NextAuthProvider>
