...
interface UpdateProfileRequest {
  ...
  bio?: string;
  timezone?: string;
  registrationNumber?: string; // Added this line
}
...
export async function PUT(req: Request) {
  try {
    ...
    // Allow updating name, branch, division, college, bio, timezone, and registrationNumber
    ...
    if (data.registrationNumber !== undefined) user.registrationNumber = data.registrationNumber.trim(); // Added this line
    ...
    return NextResponse.json({
      ...
      user: {
        ...
        registrationNumber: user.registrationNumber, // Added this line
