...
export default function PdfViewer({ documentId, currentPage, onPageChange }: PdfViewerProps) {
  ...
  return (
    <div className={cn(
      "flex flex-col border-2 border-[color:var(--border)] rounded-lg overflow-hidden relative bg-[color:var(--background)]",
      ...
      <div className={cn(
        "lg:hidden flex flex-col gap-4 p-4 bg-[color:var(--muted)]/40 border-b border-[color:var(--border)] transition-all duration-300",
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <span className="text-sm font-medium px-3 py-2 bg-[color:var(--background)] rounded-md border border-[color:var(--border)]">
      ...
      {/* Desktop Controls */}
      <div className="hidden lg:flex items-center justify-between p-2 border-b border-[color:var(--border)] bg-[color:var(--muted)]/40">
        <div className="flex items-center gap-2">
          <Button
            variant="ghost"
            size="sm"
