...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[color:var(--popover)]/80 backdrop-blur-sm border-b-2 border-[color:var(--border)] h-14">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <div className="w-7 h-7 sm:w-8 sm:h-8 bg-[#c1ff72] rounded-sm flex items-center justify-center border-2 border-black">
                <span className="text-black text-base sm:text-xl">🎓</span>
              </div>
              <span className="font-semibold text-sm sm:text-base">Brainbell</span>
            </Link>
          </div>
